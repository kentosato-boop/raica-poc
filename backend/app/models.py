...
class Candidate(TimestampMixin, Base):
    ...
    current_salary_million: Mapped[Optional[float]] = mapped_column(Float)
    ...
    work_style_options: Mapped[list[str]] = mapped_column(JSON, default=list)
    remote_preference: Mapped[str] = mapped_column(String(24), default="flexible")
    specialization: Mapped[Optional[str]] = mapped_column(String(100))
    specialization_years: Mapped[float] = mapped_column(Float, default=0)
    ...
    preferred_contact_channel: Mapped[Optional[str]] = mapped_column(String(40))
    consent_status: Mapped[str] = mapped_column(String(24), default="confirmed")
    skills: Mapped[list[str]] = mapped_column(JSON, default=list)
    internal_parallel_count: Mapped[int] = mapped_column(Integer, default=0)
    external_parallel_count: Mapped[int] = mapped_column(Integer, default=0)
    current_processes: Mapped[list[dict[str, Any]]] = mapped_column(JSON, default=list)
    skill_sheet_filename: Mapped[Optional[str]] = mapped_column(String(240))
    skill_sheet_path: Mapped[Optional[str]] = mapped_column(String(500))
    skill_sheet_uploaded_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    skill_sheet_text: Mapped[Optional[str]] = mapped_column(Text)
...
class Job(TimestampMixin, Base):
    ...
    remote_mode: Mapped[str] = mapped_column(String(24), default="onsite")
    specialization: Mapped[Optional[str]] = mapped_column(String(100))
    min_specialization_years: Mapped[float] = mapped_column(Float, default=0)
...
class Match(TimestampMixin, Base):
    ...
    specialization_score: Mapped[int] = mapped_column(Integer, default=0)
...
class ActionItem(TimestampMixin, Base):
    ...
    ball_owner: Mapped[str] = mapped_column(String(12), default="mine", index=True)
